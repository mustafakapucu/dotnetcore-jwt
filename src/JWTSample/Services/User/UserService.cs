...
namespace JWTSample.Services.User
{
    ...
    public class UserService : IUserService
    {
        ...
        public UserService(IOptions<AppSettings> _appSettings, ApplicationDbContext dbContext)
        {
        ...
        public (string username, string token)? Authenticate(string username, string password)
        {
            ...
            var user = applicationDbContext.ApplicationUsers.SingleOrDefault(x => x.Username == username && x.Password == password);
